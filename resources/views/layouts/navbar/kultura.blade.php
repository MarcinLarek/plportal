  ...
  <div class="row">
    <div class="col-12 d-flex  justify-content-between headerimage w-100" style="background-image:  url('/storage/kulturanav.png');">
        <div class="text-end pb-1 w-100">
          <form id="search" action="{{route('kultura.serach')}}" method="get">
            @csrf
    ...
    <div class="collapse navbar-collapse">
        <ul class="navbar-nav mx-auto">
          ...
          @foreach($categories as $category)
            ...
            <li class="nav-item">
              <a class="nav-link secondnavbaritem" href="{{ route('kultura.category', ['category' => $category->category]) }}">{{$category->category}}</a>
            </li>
            @endif
          @endforeach
        </ul>

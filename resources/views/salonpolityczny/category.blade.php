...
<div class="row">
    <div class="col-xl-9 col-l-9 col-md-12 col-sm-12">
        ...
        <div class="row">
            ...
            <div class="col-xl-10 col-l-10 col-md-12 col-sm-12 text-primary">
                <a href="{{ route('salonpolityczny.show', ['post' => $post->title]) }}">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-2 col-l-2 col-md-12 col-sm-12">
                ...
                <div class="mb-2 col-3 fiveobjectlist d-flex" style="width: 150px;background-image: url('/storage/{{ $post->image }}')">
                    <a class="ms-2 me-2 w-100 h-100" href="{{ route('salonpolityczny.show', ['post' => $post->title]) }}"></a>
                </div>
            </div>
    ...
    <div class="col-xl-3 col-l-3 col-md-12 col-sm-12">
        ...
        <div class="row">
            ...
            <div class="mb-2 col-3 minisquare d-flex" style="background-image: url('/storage/{{ $list->image }}')"><a class="w-100" href="{{ route('salonpolityczny.show', ['post' => $list->title]) }}">
                </a></div>

            <div class="col-9">
                <div class="">
                    <a href="{{ route('salonpolityczny.show', ['post' => $list->title]) }}">
        ...
        @endforeach
            ...
            <div class="row">
                ...
                <div class="mb-2 col-4 minisquare d-flex" style="background-image: url('/storage/{{ $list->image }}')"><a class="w-100" href="{{ route('salonpolityczny.show', ['post' => $list->title]) }}">
            </a></div>

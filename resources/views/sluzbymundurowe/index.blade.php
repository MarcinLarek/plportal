            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                      <a href="{{ route('sluzbymundurowe.show', ['post' => $firstpost->title]) }}"><h5>{{$firstpost->title}}</h5></a>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                      <a href="{{ route('sluzbymundurowe.show', ['post' => $post->title]) }}"><h5>{{$post->title}}</h5></a>
                    </div>
                </div>
                @endforeach
        ...
        @continue($loop->iteration < 5) @break($loop->iteration == 9)
            <div class="row pt-1">
                <div class="col-xl-5 col-l-5 col-md-5 col-sm-5 col-5 col-12">
                    <a href="{{ route('sluzbymundurowe.show', ['post' => $post->title]) }}"><img src="/storage/{{ $post->image }}" class="w-100 rightlistphoto"></a>
                </div>
                <div class="col-xl-7 col-l-7 col-md-7 col-sm-7 col-7 col-12 rightlisttext">
                    <a href="{{ route('sluzbymundurowe.show', ['post' => $post->title]) }}"><b>{{$post->title}}</b></a>
...
<div class="row pt-3">
  <div class="col-xl-3 col-l-3 col-md-12 col-sm-12 bordercolumns d-flex" style="background-image: url('/storage/{{$firstpost->image}}')">
    <a href="{{ route('sluzbymundurowe.show', ['post' => $firstpost->title]) }}"><h1> <b>{{$firstpost->title}}</b> </h1></a>
  </div>
  <div class="col-xl-6 col-l-6 col-md-12 col-sm-12">
    <div class="row">
      <div class="col-xl-6 col-l-6 col-md-12 col-sm-12">
        <a class="ms-2 me-2" href="{{ route('sluzbymundurowe.show', ['post' => $posts[0]->title]) }}">
        <div class="mb-2 col-3 w-100 squarecolumns d-flex" style="background-image: url('/storage/{{$posts[0]->image}}')">
          <h5> <b>{{$posts[0]->title}}</b> </h5>
        </div>
        </a>
        <a class="ms-2 me-2" href="{{ route('sluzbymundurowe.show', ['post' => $posts[2]->title]) }}">
      ...
      <div class="col-xl-6 col-l-6 col-md-12 col-sm-12">
        <a class="ms-2 me-2" href="{{ route('sluzbymundurowe.show', ['post' => $posts[1]->title]) }}">
        <div class="mb-2 col-3 w-100 squarecolumns d-flex" style="background-image: url('/storage/{{$posts[1]->image}}')">
          <h5> <b>{{$posts[1]->title}}</b> </h5>
        </div>
        </a>
        <a class="ms-2 me-2" href="{{ route('sluzbymundurowe.show', ['post' => $posts[3]->title]) }}">
            ...
            <div class="row">
              <div class="col-5">
                <div class="mb-2 col-3 w-100 minicolumns d-flex" style="background-image: url('/storage/{{ $minipost->image }}')">
                  <a class="ms-2 me-2 w-100" href="{{ route('sluzbymundurowe.show', ['post' => $minipost->title]) }}"></a>
                </div>
              </div>
              <div class="col-7 minicolumns">
                <a class="ms-2 me-2 w-100" href="{{ route('sluzbymundurowe.show', ['post' => $minipost->title]) }}"><b>{{$minipost->title}}</b></a>
              </div>
            </div>
            @endif
        @endforeach
            ...
            <div class="row">
              <div class="col-5">
                <div class="mb-2 col-3 w-100 minicolumns d-flex" style="background-image: url('/storage/{{ $minipost2->image }}')">
                  <a class="ms-2 me-2 w-100" href="{{ route('sluzbymundurowe.show', ['post' => $minipost2->title]) }}"></a>
                </div>
              </div>
              <div class="col-7 minicolumns">
                <a class="ms-2 me-2 w-100" href="{{ route('sluzbymundurowe.show', ['post' => $minipost->title]) }}"><b>{{$minipost2->title}}</b></a>
              </div>
            </div>
            @endif
        @endforeach
